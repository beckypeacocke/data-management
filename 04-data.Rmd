...
Increasingly, I've started moving towards **capturing data directly into a spreadsheet** with data validation rules using a phone or tablet. There are also a number of "no code" app builders these days like [**AppSheet**](https://www.appsheet.com) that allows you to easily collect data on your phone and sync data directly into Google Sheets and photos to your Google Drive. AppSheet is proprietary software, but does allow a lot of utility with their free accounts. [**Epicollect**](https://five.epicollect.net/) is a similar open source app provided by the University of Oxford that allows you to build data collection forms and deploy them to your phone, tablet etc. It is becoming my go-to option for standardised data collection. [**QField**](https://qfield.org/) is another handy open source app built on QGIS, allowing you to setup maps and forms in QGIS on your workstation and then deploy them to your phone, tablet etc. It seems to be getting better all the time.
